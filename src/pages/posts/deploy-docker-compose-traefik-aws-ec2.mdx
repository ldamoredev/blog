...
import traefikImg from "../../assets/deploy-docker-compose-traefik-aws-ec2/traefik.png";
import ec20Img from "../../assets/deploy-docker-compose-traefik-aws-ec2/ec2_0.png";
import ec21Img from "../../assets/deploy-docker-compose-traefik-aws-ec2/ec2_1.png";
import ec22Img from "../../assets/deploy-docker-compose-traefik-aws-ec2/ec2_2.png";
import ec23Img from "../../assets/deploy-docker-compose-traefik-aws-ec2/ec2_3.png";
import ec24Img from "../../assets/deploy-docker-compose-traefik-aws-ec2/ec2_4.png";
import repoImg from "../../assets/deploy-docker-compose-traefik-aws-ec2/repo.png";
import ellasticIp1Img from "../../assets/deploy-docker-compose-traefik-aws-ec2/ellastic_ip1.png";
import ellasticIp2Img from "../../assets/deploy-docker-compose-traefik-aws-ec2/ellastic_ip2.png";
import ellasticIp3Img from "../../assets/deploy-docker-compose-traefik-aws-ec2/ellastic_ip3.png";
import dnsImg from "../../assets/deploy-docker-compose-traefik-aws-ec2/dns.png";
import finishImg from "../../assets/deploy-docker-compose-traefik-aws-ec2/finish.png";

En este tutorial vamos a configurar un instancia de EC2 para deployar nuestro Docker Compose con Traefik, un frontend y un backend:
...
Hablando con mis jefes nos dimos cuenta que era un desperdicio gastar esa plata para el ambiente de staging, por lo que pasamos a un esquema mas barato.
